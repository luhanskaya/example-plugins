    ...
    class MV_Slider_Post_Type
    {
        ...
        public function create_post_type()
        {
            register_post_type(
                ...
                array(
                    ...
                    // 'register_meta_box_cb'  => array($this, 'add_meta_boxes'), // second variant of registration
                ),
            );
        }
        ...
        public function save_post($post_id)
        {
            if (isset($_POST['mv_slider_nonce'])) {
                if (!wp_verify_nonce($_POST['mv_slider_nonce'], 'mv_slider_nonce')) return;
            }
            ...
            if (isset($_POST['action']) && $_POST['action'] == 'editpost') {
                ...
                $new_link_url = esc_url_raw($_POST['mv_slider_link_url']); // sanitize_text_field($_POST['mv_slider_link_url']);
